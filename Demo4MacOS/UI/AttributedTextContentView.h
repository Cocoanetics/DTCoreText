 ...
 */
@protocol AttributedTextContentViewDelegate <NSObject>
 ...
 */
- (NSView *)attributedTextContentView:(AttributedTextContentView *)attributedTextContentView viewForAttachment:(DTTextAttachment *)attachment frame:(CGRect)frame;
 ...
 */
- (NSView *)attributedTextContentView:(AttributedTextContentView *)attributedTextContentView viewForAttributedString:(NSAttributedString *)string frame:(CGRect)frame;
...
@interface AttributedTextContentView : NSView
{
...
@property (nonatomic, DT_WEAK_PROPERTY) IBOutlet id <AttributedTextContentViewDelegate> delegate;
