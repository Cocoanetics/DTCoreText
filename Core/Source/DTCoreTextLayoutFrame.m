...
- (void)_drawHorizontalRuleFromLine:(DTCoreTextLayoutLine *)line inContext:(CGContextRef)context
{
	...
	CGColorRef backgroundColor = (__bridge CGColorRef)[oneRun.attributes objectForKey:DTForegroundColorAttribute];
    
	// can also be iOS 6 attribute
#if __IPHONE_OS_VERSION_MAX_ALLOWED > __IPHONE_5_1
	if (!backgroundColor && ___useiOS6Attributes)
	{
		UIColor *uiColor = [oneRun.attributes objectForKey:DTForegroundColorAttribute];
