...
- (void)testEmptyListItemWithSubList
{
	...
	// first paragraph should have two lists
	NSArray *firstParagraphLists = [attributedString attribute:DTTextListsAttribute atIndex:0 effectiveRange:NULL];
	
	NSUInteger firstListsCount = [firstParagraphLists count];
	
	STAssertTrue(firstListsCount == 2, @"There should be two lists on the first paragraph");
