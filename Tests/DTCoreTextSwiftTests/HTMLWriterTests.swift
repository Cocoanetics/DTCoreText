...
struct HTMLWriterTests {
	...
	@Test("Nested list round trip", .disabled("Nested list round-trip length mismatch after Swift migration — see #1305"))
	...
	@Test("Nested list round trip with preceding element", .disabled("Nested list round-trip length mismatch — see #1305"))
	...
	@Test("Nested list output without text node round trip", .disabled("Nested list round-trip length mismatch — see #1305"))
