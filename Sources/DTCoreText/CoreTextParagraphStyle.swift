...
public class CoreTextParagraphStyle: NSObject, NSCopying {
  ...
  @objc public class func paragraphStyle(with ctParagraphStyle: CTParagraphStyle)
  ...
  @objc public init(ctParagraphStyle: CTParagraphStyle) {
    ...
    CTParagraphStyleGetValueForSpecifier(
      ctParagraphStyle, .alignment, MemoryLayout<CTTextAlignment>.size, &alignment)
    CTParagraphStyleGetValueForSpecifier(
      ctParagraphStyle, .firstLineHeadIndent, MemoryLayout<CGFloat>.size, &firstLineHeadIndent)
    CTParagraphStyleGetValueForSpecifier(
      ctParagraphStyle, .headIndent, MemoryLayout<CGFloat>.size, &headIndent)
    CTParagraphStyleGetValueForSpecifier(
      ctParagraphStyle, .tailIndent, MemoryLayout<CGFloat>.size, &tailIndent)
    CTParagraphStyleGetValueForSpecifier(
      ctParagraphStyle, .paragraphSpacing, MemoryLayout<CGFloat>.size, &paragraphSpacing)
    CTParagraphStyleGetValueForSpecifier(
      ctParagraphStyle, .paragraphSpacingBefore, MemoryLayout<CGFloat>.size, &paragraphSpacingBefore
    )
    CTParagraphStyleGetValueForSpecifier(
      ctParagraphStyle, .defaultTabInterval, MemoryLayout<CGFloat>.size, &defaultTabInterval)

    var stops: Unmanaged<CFArray>?
    if CTParagraphStyleGetValueForSpecifier(
      ctParagraphStyle, .tabStops, MemoryLayout<Unmanaged<CFArray>?>.size, &stops)
    {
    ...
    CTParagraphStyleGetValueForSpecifier(
      ctParagraphStyle, .baseWritingDirection, MemoryLayout<CTWritingDirection>.size,
      &baseWritingDirection)
    CTParagraphStyleGetValueForSpecifier(
      ctParagraphStyle, .minimumLineHeight, MemoryLayout<CGFloat>.size, &minimumLineHeight)
    CTParagraphStyleGetValueForSpecifier(
      ctParagraphStyle, .maximumLineHeight, MemoryLayout<CGFloat>.size, &maximumLineHeight)
    CTParagraphStyleGetValueForSpecifier(
      ctParagraphStyle, .lineHeightMultiple, MemoryLayout<CGFloat>.size, &lineHeightMultiple)
  }
  ...
  public class func paragraphStyle(withNSParagraphStyle paragraphStyle: NSParagraphStyle?)
    -> CoreTextParagraphStyle
  {
  ...
  @objc public func createCTParagraphStyle() -> CTParagraphStyle {
    ...
    withUnsafePointer(to: &alignment) { ptr in
      settings.append(
        CTParagraphStyleSetting(
          spec: .alignment, valueSize: MemoryLayout<CTTextAlignment>.size, value: ptr))
    }
    withUnsafePointer(to: &firstLineHeadIndent) { ptr in
      settings.append(
        CTParagraphStyleSetting(
          spec: .firstLineHeadIndent, valueSize: MemoryLayout<CGFloat>.size, value: ptr))
    }
    withUnsafePointer(to: &defaultTabInterval) { ptr in
      settings.append(
        CTParagraphStyleSetting(
          spec: .defaultTabInterval, valueSize: MemoryLayout<CGFloat>.size, value: ptr))
    }
    ...
    return withExtendedLifetime(stops) {
      ...
      withUnsafePointer(to: &stopsPtr) { ptr in
        settings.append(
          CTParagraphStyleSetting(
            spec: .tabStops, valueSize: MemoryLayout<CFArray?>.size, value: ptr))
      }
      ...
      withUnsafePointer(to: &paragraphSpacingBefore) { ptr in
        settings.append(
          CTParagraphStyleSetting(
            spec: .paragraphSpacingBefore, valueSize: MemoryLayout<CGFloat>.size, value: ptr))
      }
      withUnsafePointer(to: &headIndent) { ptr in
        settings.append(
          CTParagraphStyleSetting(
            spec: .headIndent, valueSize: MemoryLayout<CGFloat>.size, value: ptr))
      }
      withUnsafePointer(to: &tailIndent) { ptr in
        settings.append(
          CTParagraphStyleSetting(
            spec: .tailIndent, valueSize: MemoryLayout<CGFloat>.size, value: ptr))
      }
      ...
      withUnsafePointer(to: &minimumLineHeight) { ptr in
        settings.append(
          CTParagraphStyleSetting(
            spec: .minimumLineHeight, valueSize: MemoryLayout<CGFloat>.size, value: ptr))
      }
      withUnsafePointer(to: &maximumLineHeight) { ptr in
        settings.append(
          CTParagraphStyleSetting(
            spec: .maximumLineHeight, valueSize: MemoryLayout<CGFloat>.size, value: ptr))
      }
  ...
  public override func isEqual(_ object: Any?) -> Bool {
    ...
    if let ts = _tabStops,
      !(ts.isEqual(to: (otherStyle._tabStops ?? NSMutableArray()) as [AnyObject]))
    {
      return false
    }
