...
extension NSAttributedString {
  ...
  public convenience init?(
    htmlData data: Data, documentAttributes: AutoreleasingUnsafeMutablePointer<NSDictionary?>?
  ) {
  ...
  public convenience init?(
    htmlData data: Data, baseURL: URL?,
  ...
  public convenience init?(
    htmlData data: Data, options: [String: Any],
    documentAttributes: AutoreleasingUnsafeMutablePointer<NSDictionary?>?
  ) {
