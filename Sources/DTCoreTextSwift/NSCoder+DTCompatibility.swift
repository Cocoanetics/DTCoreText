...
public extension NSCoder {
    ...
    @objc func encodeCGSize(_ size: CGSize, forKey key: String) {
    ...
    @objc func decodeCGSize(forKey key: String) -> CGSize {
    ...
    @objc func decodeDTEdgeInsets(forKey key: String) -> DTEdgeInsets {
        #if canImport(UIKit)
