...
public let DTAttributedTextContentViewDidFinishLayoutNotification = "DTAttributedTextContentViewDidFinishLayoutNotification"
...
@objc public protocol DTAttributedTextContentViewDelegate: NSObjectProtocol {
	...
	@objc optional func attributedTextContentView(_ attributedTextContentView: AttributedTextContentView,
...
open class AttributedTextContentView: UIView, @preconcurrency AccessibilityViewProxyDelegate {
		...
		get {
			...
			if _layoutFrame == nil {
				...
				if _delegateFlags.supportsNotificationBeforeTextBoxDrawing {
					_layoutFrame?.textBlockHandler = { [weak self] textBlock, blockFrame, context, shouldDrawDefaultBackground in
						guard let self else { return }
	...
	open func contentImage(with contentBounds: CGRect, options: CoreTextLayoutFrameDrawingOptions) -> UIImage? {
	...
	open override var accessibilityElements: [Any]? {
		get {
			if _accessibilityElements == nil, let layoutFrame = self.layoutFrame {
				...
				_accessibilityElements = generator.accessibilityElements(for: layoutFrame, view: self) { [weak self] (attachment: TextAttachment) -> Any? in
